...
{
    /// <summary>
    /// Controller responsible for managing refund-related operations in the API.
    /// </summary>
    /// <remarks>
    ...
    public class RefundController : ControllerBase
    {
        ...
        public RefundController(TicketBookingContext context)
        {
            _context = context;
        }

        /// <summary>Adds a new refund to the database</summary>
        ...
        public IActionResult Get([FromQuery] string filters, string searchTerm, int pageNumber = 1, int pageSize = 10, string sortField = null, string sortOrder = "asc")
        {
            ...
            var query = _context.Refund.IncludeRelated().AsQueryable();
        ...
        {
            var entityData = _context.Refund.IncludeRelated().FirstOrDefault(entity => entity.Id == id);
        ...
        public IActionResult DeleteById([FromRoute] Guid id)
        {
            ...
            _context.Refund.Remove(entityData);
        ...
        public IActionResult UpdateById(Guid id, [FromBody] Refund updatedEntity)
        {
            ...
            this._context.Refund.Update(updatedEntity);
            var status = this._context.SaveChanges();
            return Ok(new { status });
        }
        ...
        public IActionResult UpdateById(Guid id, [FromBody] JsonPatchDocument<Refund> updatedEntity)
        {
            ...
            var existingEntity = this._context.Refund.FirstOrDefault(t => t.Id == id);
            if (existingEntity == null)
                return NotFound();
            updatedEntity.ApplyTo(existingEntity, ModelState);
            if (!ModelState.IsValid)
                return BadRequest(ModelState);
            this._context.Refund.Update(existingEntity);
            var status = this._context.SaveChanges();
            return Ok(new { status });
        }
    }
