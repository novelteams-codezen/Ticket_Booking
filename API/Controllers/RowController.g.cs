...
{
    /// <summary>
    /// Controller responsible for managing row-related operations in the API.
    /// </summary>
    /// <remarks>
    ...
    public class RowController : ControllerBase
    {
        ...
        public RowController(TicketBookingContext context)
        {
            _context = context;
        }

        /// <summary>Adds a new row to the database</summary>
        ...
        public IActionResult Get([FromQuery] string filters, string searchTerm, int pageNumber = 1, int pageSize = 10, string sortField = null, string sortOrder = "asc")
        {
            ...
            var query = _context.Row.IncludeRelated().AsQueryable();
        ...
        {
            var entityData = _context.Row.IncludeRelated().FirstOrDefault(entity => entity.Id == id);
        ...
        public IActionResult DeleteById([FromRoute] Guid id)
        {
            ...
            _context.Row.Remove(entityData);
        ...
        public IActionResult UpdateById(Guid id, [FromBody] Row updatedEntity)
        {
            ...
            this._context.Row.Update(updatedEntity);
            var status = this._context.SaveChanges();
            return Ok(new { status });
        }
        ...
        public IActionResult UpdateById(Guid id, [FromBody] JsonPatchDocument<Row> updatedEntity)
        {
            ...
            var existingEntity = this._context.Row.FirstOrDefault(t => t.Id == id);
            if (existingEntity == null)
                return NotFound();
            updatedEntity.ApplyTo(existingEntity, ModelState);
            if (!ModelState.IsValid)
                return BadRequest(ModelState);
            this._context.Row.Update(existingEntity);
            var status = this._context.SaveChanges();
            return Ok(new { status });
        }
    }
