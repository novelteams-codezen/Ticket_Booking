...
{
    /// <summary>
    /// Controller responsible for managing eventcategory-related operations in the API.
    /// </summary>
    /// <remarks>
    ...
    public class EventCategoryController : ControllerBase
    {
        ...
        public EventCategoryController(TicketBookingContext context)
        {
            _context = context;
        }

        /// <summary>Adds a new eventcategory to the database</summary>
        ...
        {
            _context.EventCategory.Add(model);
        ...
        public IActionResult Get([FromQuery] string filters, string searchTerm, int pageNumber = 1, int pageSize = 10, string sortField = null, string sortOrder = "asc")
        {
            ...
            var query = _context.EventCategory.IncludeRelated().AsQueryable();
        ...
        {
            var entityData = _context.EventCategory.IncludeRelated().FirstOrDefault(entity => entity.Id == id);
        ...
        public IActionResult DeleteById([FromRoute] Guid id)
        {
            ...
            _context.EventCategory.Remove(entityData);
        ...
        public IActionResult UpdateById(Guid id, [FromBody] EventCategory updatedEntity)
        {
            ...
            this._context.EventCategory.Update(updatedEntity);
            var status = this._context.SaveChanges();
            return Ok(new { status });
        }
        ...
        public IActionResult UpdateById(Guid id, [FromBody] JsonPatchDocument<EventCategory> updatedEntity)
        {
            ...
            var existingEntity = this._context.EventCategory.FirstOrDefault(t => t.Id == id);
            if (existingEntity == null)
                return NotFound();
            updatedEntity.ApplyTo(existingEntity, ModelState);
            if (!ModelState.IsValid)
                return BadRequest(ModelState);
            this._context.EventCategory.Update(existingEntity);
            var status = this._context.SaveChanges();
            return Ok(new { status });
        }
    }
