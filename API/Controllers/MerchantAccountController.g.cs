...
{
    /// <summary>
    /// Controller responsible for managing merchantaccount-related operations in the API.
    /// </summary>
    /// <remarks>
    ...
    public class MerchantAccountController : ControllerBase
    {
        ...
        public MerchantAccountController(TicketBookingContext context)
        {
            _context = context;
        }

        /// <summary>Adds a new merchantaccount to the database</summary>
        ...
        {
            _context.MerchantAccount.Add(model);
        ...
        public IActionResult Get([FromQuery] string filters, string searchTerm, int pageNumber = 1, int pageSize = 10, string sortField = null, string sortOrder = "asc")
        {
            ...
            var query = _context.MerchantAccount.IncludeRelated().AsQueryable();
        ...
        {
            var entityData = _context.MerchantAccount.IncludeRelated().FirstOrDefault(entity => entity.Id == id);
        ...
        public IActionResult DeleteById([FromRoute] Guid id)
        {
            ...
            _context.MerchantAccount.Remove(entityData);
        ...
        public IActionResult UpdateById(Guid id, [FromBody] MerchantAccount updatedEntity)
        {
            ...
            this._context.MerchantAccount.Update(updatedEntity);
            var status = this._context.SaveChanges();
            return Ok(new { status });
        }
        ...
        public IActionResult UpdateById(Guid id, [FromBody] JsonPatchDocument<MerchantAccount> updatedEntity)
        {
            ...
            var existingEntity = this._context.MerchantAccount.FirstOrDefault(t => t.Id == id);
            if (existingEntity == null)
                return NotFound();
            updatedEntity.ApplyTo(existingEntity, ModelState);
            if (!ModelState.IsValid)
                return BadRequest(ModelState);
            this._context.MerchantAccount.Update(existingEntity);
            var status = this._context.SaveChanges();
            return Ok(new { status });
        }
    }
