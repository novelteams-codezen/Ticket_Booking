...
{
    /// <summary>
    /// Controller responsible for managing venue-related operations in the API.
    /// </summary>
    /// <remarks>
    ...
    public class VenueController : ControllerBase
    {
        ...
        public VenueController(TicketBookingContext context)
        {
            _context = context;
        }

        /// <summary>Adds a new venue to the database</summary>
        ...
        public IActionResult Get([FromQuery] string filters, string searchTerm, int pageNumber = 1, int pageSize = 10, string sortField = null, string sortOrder = "asc")
        {
            ...
            var query = _context.Venue.IncludeRelated().AsQueryable();
        ...
        {
            var entityData = _context.Venue.IncludeRelated().FirstOrDefault(entity => entity.Id == id);
        ...
        public IActionResult DeleteById([FromRoute] Guid id)
        {
            ...
            _context.Venue.Remove(entityData);
        ...
        public IActionResult UpdateById(Guid id, [FromBody] Venue updatedEntity)
        {
            ...
            this._context.Venue.Update(updatedEntity);
            var status = this._context.SaveChanges();
            return Ok(new { status });
        }
        ...
        public IActionResult UpdateById(Guid id, [FromBody] JsonPatchDocument<Venue> updatedEntity)
        {
            ...
            var existingEntity = this._context.Venue.FirstOrDefault(t => t.Id == id);
            if (existingEntity == null)
                return NotFound();
            updatedEntity.ApplyTo(existingEntity, ModelState);
            if (!ModelState.IsValid)
                return BadRequest(ModelState);
            this._context.Venue.Update(existingEntity);
            var status = this._context.SaveChanges();
            return Ok(new { status });
        }
    }
