...
{
    /// <summary>
    /// Controller responsible for managing reservation-related operations in the API.
    /// </summary>
    /// <remarks>
    ...
    public class ReservationController : ControllerBase
    {
        ...
        public ReservationController(TicketBookingContext context)
        {
            _context = context;
        }

        /// <summary>Adds a new reservation to the database</summary>
        ...
        public IActionResult Get([FromQuery] string filters, string searchTerm, int pageNumber = 1, int pageSize = 10, string sortField = null, string sortOrder = "asc")
        {
            ...
            var query = _context.Reservation.IncludeRelated().AsQueryable();
        ...
        {
            var entityData = _context.Reservation.IncludeRelated().FirstOrDefault(entity => entity.Id == id);
        ...
        public IActionResult DeleteById([FromRoute] Guid id)
        {
            ...
            _context.Reservation.Remove(entityData);
        ...
        public IActionResult UpdateById(Guid id, [FromBody] Reservation updatedEntity)
        {
            ...
            this._context.Reservation.Update(updatedEntity);
            var status = this._context.SaveChanges();
            return Ok(new { status });
        }
        ...
        public IActionResult UpdateById(Guid id, [FromBody] JsonPatchDocument<Reservation> updatedEntity)
        {
            ...
            var existingEntity = this._context.Reservation.FirstOrDefault(t => t.Id == id);
            if (existingEntity == null)
                return NotFound();
            updatedEntity.ApplyTo(existingEntity, ModelState);
            if (!ModelState.IsValid)
                return BadRequest(ModelState);
            this._context.Reservation.Update(existingEntity);
            var status = this._context.SaveChanges();
            return Ok(new { status });
        }
    }
