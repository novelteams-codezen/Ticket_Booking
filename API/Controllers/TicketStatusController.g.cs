...
{
    /// <summary>
    /// Controller responsible for managing ticketstatus-related operations in the API.
    /// </summary>
    /// <remarks>
    ...
    public class TicketStatusController : ControllerBase
    {
        ...
        public TicketStatusController(TicketBookingContext context)
        {
            _context = context;
        }

        /// <summary>Adds a new ticketstatus to the database</summary>
        ...
        {
            _context.TicketStatus.Add(model);
        ...
        public IActionResult Get([FromQuery] string filters, string searchTerm, int pageNumber = 1, int pageSize = 10, string sortField = null, string sortOrder = "asc")
        {
            ...
            var query = _context.TicketStatus.IncludeRelated().AsQueryable();
        ...
        {
            var entityData = _context.TicketStatus.IncludeRelated().FirstOrDefault(entity => entity.Id == id);
        ...
        public IActionResult DeleteById([FromRoute] Guid id)
        {
            ...
            _context.TicketStatus.Remove(entityData);
        ...
        public IActionResult UpdateById(Guid id, [FromBody] TicketStatus updatedEntity)
        {
            ...
            this._context.TicketStatus.Update(updatedEntity);
            var status = this._context.SaveChanges();
            return Ok(new { status });
        }
        ...
        public IActionResult UpdateById(Guid id, [FromBody] JsonPatchDocument<TicketStatus> updatedEntity)
        {
            ...
            var existingEntity = this._context.TicketStatus.FirstOrDefault(t => t.Id == id);
            if (existingEntity == null)
                return NotFound();
            updatedEntity.ApplyTo(existingEntity, ModelState);
            if (!ModelState.IsValid)
                return BadRequest(ModelState);
            this._context.TicketStatus.Update(existingEntity);
            var status = this._context.SaveChanges();
            return Ok(new { status });
        }
    }
