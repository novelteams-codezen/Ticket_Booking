...
{
    /// <summary>
    /// Controller responsible for managing ticketholder-related operations in the API.
    /// </summary>
    /// <remarks>
    ...
    public class TicketHolderController : ControllerBase
    {
        ...
        public TicketHolderController(TicketBookingContext context)
        {
            _context = context;
        }

        /// <summary>Adds a new ticketholder to the database</summary>
        ...
        {
            _context.TicketHolder.Add(model);
        ...
        public IActionResult Get([FromQuery] string filters, string searchTerm, int pageNumber = 1, int pageSize = 10, string sortField = null, string sortOrder = "asc")
        {
            ...
            var query = _context.TicketHolder.IncludeRelated().AsQueryable();
        ...
        {
            var entityData = _context.TicketHolder.IncludeRelated().FirstOrDefault(entity => entity.Id == id);
        ...
        public IActionResult DeleteById([FromRoute] Guid id)
        {
            ...
            _context.TicketHolder.Remove(entityData);
        ...
        public IActionResult UpdateById(Guid id, [FromBody] TicketHolder updatedEntity)
        {
            ...
            this._context.TicketHolder.Update(updatedEntity);
            var status = this._context.SaveChanges();
            return Ok(new { status });
        }
        ...
        public IActionResult UpdateById(Guid id, [FromBody] JsonPatchDocument<TicketHolder> updatedEntity)
        {
            ...
            var existingEntity = this._context.TicketHolder.FirstOrDefault(t => t.Id == id);
            if (existingEntity == null)
                return NotFound();
            updatedEntity.ApplyTo(existingEntity, ModelState);
            if (!ModelState.IsValid)
                return BadRequest(ModelState);
            this._context.TicketHolder.Update(existingEntity);
            var status = this._context.SaveChanges();
            return Ok(new { status });
        }
    }
