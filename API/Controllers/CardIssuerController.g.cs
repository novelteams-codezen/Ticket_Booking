...
{
    /// <summary>
    /// Controller responsible for managing cardissuer-related operations in the API.
    /// </summary>
    /// <remarks>
    ...
    public class CardIssuerController : ControllerBase
    {
        ...
        public CardIssuerController(TicketBookingContext context)
        {
            _context = context;
        }

        /// <summary>Adds a new cardissuer to the database</summary>
        ...
        public IActionResult Get([FromQuery] string filters, string searchTerm, int pageNumber = 1, int pageSize = 10, string sortField = null, string sortOrder = "asc")
        {
            ...
            var query = _context.CardIssuer.IncludeRelated().AsQueryable();
        ...
        {
            var entityData = _context.CardIssuer.IncludeRelated().FirstOrDefault(entity => entity.Id == id);
        ...
        public IActionResult DeleteById([FromRoute] Guid id)
        {
            ...
            _context.CardIssuer.Remove(entityData);
        ...
        public IActionResult UpdateById(Guid id, [FromBody] CardIssuer updatedEntity)
        {
            ...
            this._context.CardIssuer.Update(updatedEntity);
            var status = this._context.SaveChanges();
            return Ok(new { status });
        }
        ...
        public IActionResult UpdateById(Guid id, [FromBody] JsonPatchDocument<CardIssuer> updatedEntity)
        {
            ...
            var existingEntity = this._context.CardIssuer.FirstOrDefault(t => t.Id == id);
            if (existingEntity == null)
                return NotFound();
            updatedEntity.ApplyTo(existingEntity, ModelState);
            if (!ModelState.IsValid)
                return BadRequest(ModelState);
            this._context.CardIssuer.Update(existingEntity);
            var status = this._context.SaveChanges();
            return Ok(new { status });
        }
    }
